 ...
 * @author: 汪大鹏
 * @version: 1.0.0
 * @date: 2026/5/27 19:32
 * // 简单路径数量，java版
 * // 图中有n个点、n条无向边，图是一棵基环树
 * // 路径长度为边的数量，要求路径长度 >= 1，求这样的路径数量是多少
 * // 路径a、b、c和c、b、a，认为是同一条简单路径，不要重复计算
 * // 3 <= n <= 2 * 10^5
...
public class Code02_NumberOfSimplePaths1 {
    ...
    public static boolean[] cycel = new boolean[MAXN];
