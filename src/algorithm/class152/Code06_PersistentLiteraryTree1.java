...
public class Code06_PersistentLiteraryTree1 {
    ...
    public static int MAXM = 100 * MAXN;
    ...
    public static void main(String[] args) throws IOException {
        ...
        long lastAns = 0;
        for (int i = 1, version, op, x = 0, y = 0; i <= n; i++) {
            in.nextToken(); version = (int) in.nval;
            in.nextToken(); op = (int) in.nval;
            in.nextToken(); x = (int) ((long) in.nval ^ lastAns);
            if (op != 2) {
                in.nextToken();
