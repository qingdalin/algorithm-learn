...
public class Code04_SegmentTreeAddSetminQueryMaxSum {
    ...
    private static void lazy(int i, int n, long maxAddv, long otherAddv) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0, op, jobl, jobr, a, b, jobv; i < t; i++) {
            ...
            if (op == 0) {
                ...
                long ans2 = checkMax(check, jobl, jobr);
                if (ans1 != ans2) {
    ...
    private static void checkAdd(int[] check, int jobl, int jobr, int jobv) {
    ...
    private static long checkMax(int[] check, int jobl, int jobr) {
        long ans = Long.MIN_VALUE;
        for (int i = jobl; i <= jobr; i++) {
