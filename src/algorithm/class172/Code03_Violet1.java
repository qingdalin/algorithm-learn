...
public class Code03_Violet1 {
    ...
    public static int query(int l, int r) {
        ...
        if (bi[l] == bi[r]) {
            ...
            for (int i = l; i <= r; i++) {
                int cur = arr[i];
                if (numCnt[cur] > numCnt[most] || (numCnt[cur] == numCnt[most] && cur < most)) {
                    most = cur;
                }
            }
            for (int i = l; i <= r; i++) {
