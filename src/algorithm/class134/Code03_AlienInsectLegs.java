...
public class Code03_AlienInsectLegs {
    ...
    public static long[][] mat = new long[MAXN][(MAXN / BIT) + 1];
    public static int n, m, s, need;
    ...
    private static void eor(int row1, int row2, int bits) {
    ...
    private static void set(int row, int col, int v) {
        if (v == 0) {
