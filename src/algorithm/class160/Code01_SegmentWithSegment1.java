...
public class Code01_SegmentWithSegment1 {
    ...
    public static int MAXX = 200, MINX = 100, MAXY = 1000, MINY = 0;
...
//                    in.nextToken(); b = (int) (in.nval * 10);
//                    in.nextToken(); c = (int) (in.nval * 10);
//                    outerUpdate(a, b, c, MINX, MAXX, 1);
//                } else {
//                    in.nextToken(); a = (int) in.nval;
//                    in.nextToken(); b = (int) in.nval;
//                    in.nextToken(); c = (int) (in.nval * 10);
//                    in.nextToken(); d = (int) (in.nval * 10);
//                    int xl = Math.min(a, b);
//                    int xr = Math.max(a, b);
//                    int yl = Math.min(c, d);
//                    int yr = Math.max(c, d);
