...
public class Code06_LineUp1 {
    ...
    public static void add(int i, int v) {
        // 错误写法 for (int j = 1; j <= n; j += lowbit(j)) {
    ...
    public static int compute(int a, int b) {
        // .....a.....b......
        // a移动到b减少的逆序对，a+1--b-1中间1-arr[a]-1
        ans -= query(a + 1, b - 1, 1, arr[a] - 1);
        // a移动到b增加的逆序对，a+1--b-1中间arr[a]+1-s
        ans += query(a + 1, b - 1, arr[a] + 1, s);
        // b移动到a减少的逆序对，a+1--b-1中间arr[b]+1-s
        ans -= query(a + 1, b - 1, arr[b] + 1, s);
        // b移动到a增加的逆序对，a+1--b-1中间1-arr[b]-1
