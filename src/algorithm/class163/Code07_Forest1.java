...
public class Code07_Forest1 {
    ...
    public static int[] setSize = new int[MAXN];
    ...
    public static int lca(int a, int b) {
        ...
        for (int p = MAXH - 1; p >= 0; p--) {
            // TODO 错误写法 if (deep[stjump[a][p]] >= deep[b]) {
    ...
    public static int queryKth(int x, int y, int k) {
        ...
        int i = query(k, 1, diff, root[x], root[y], root[lca], root[lcafa]);
        return sorted[i];
    }

    public static void dfs1(int u, int fa, int treeh) {
        // 错误写法 root[u] = insert(arr[u], 1, diff, treeh);
    ...
    public static int stackSize, cur, father, edge, treehead;
    ...
    public static void dfs2(int u, int fa, int treeh) {
        stackSize = 0;
        push(u, fa, treeh, -1);
        while (stackSize > 0) {
            pop();
    ...
    public static void main(String[] args) throws IOException {
        ...
        in.nextToken(); testcase = (int) in.nval;
        ...
        for (int i = 1; i <= t; i++) {
            ...
            in.nextToken(); x = ((int) in.nval) ^ lastAns;
            in.nextToken(); y = ((int) in.nval) ^ lastAns;
            if (op.equals("Q")) {
                in.nextToken(); k = ((int) in.nval) ^ lastAns;
