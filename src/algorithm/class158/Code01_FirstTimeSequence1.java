    ...
    public static void prepare() {
        ...
        for (int i = n; i >= 1; i--) {
            if (pos[arr[i]] == 0) {
                ...
                // 错误写法 root[i] = update(pos[arr[i]], -1, 1, n, root[n + 1]);
...
//        in.nextToken(); cases = (int) in.nval;
//        for (int t = 1; t <= cases; t++) {
...
//            prepare();
//            out.print("Case #" + t + ":");
//            int l, r, a, b, left, right, k;
//            int lastAns = 0;
//            for (int i = 1; i <= m; i++) {
//                in.nextToken(); left = (int) in.nval;
//                in.nextToken(); right = (int) in.nval;
//                a = (left + lastAns) % n + 1;
//                b = (right + lastAns) % n + 1;
//                l = Math.min(a, b);
//                r = Math.max(a, b);
